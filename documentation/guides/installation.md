...
1. Check :doc:`guides/troubleshooting`
...
1. Follow the :doc:`guides/quickstart` for hands-on experience
2. Read the `README.md <../README.md>`_ for an overview (external reference)
3. Explore the `Examples <https://github.com/epics-base/pvxs/tree/master/example>`_
4. Review the :doc:`api/overview` API Documentation
5. Check :doc:`guides/architecture` for design details
