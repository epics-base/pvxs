...
int readParameters(int argc, char *argv[], const char *program_name, ConfigCms &config, std::map<const std::string, std::unique_ptr<client::Config>> &authn_config_map, bool &verbose, std::string &admin_name) {
