...
ossl_ptr<X509> getCertificate(bool &retrieved_credentials, ConfigLdap config, uint16_t cert_usage, AuthNLdap authenticator, const std::string tls_keychain_file, const std::string tls_keychain_pwd) {
