...
#define TEST_STATUS_REQUEST(LNAME)                                                                                       \
    try {                                                                                                                \
        testDiag("Sending: %s: %s", "Server Status Request",  LNAME##_status_pv_name.c_str());                           \
...
/**
 * @brief Certificate serial numbers used by a test system and generated by gen_test_certs
 */
